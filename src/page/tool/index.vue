...
export default {
  ...
  methods: {
    ...
    turnData(checkList, data, checkListGroup) {
      console.log('zhuanhuan shuju')
      // 数据保留2位小数
      // lhr改
      // const params = ['rDealList', 'rTransformList', 'rVisitList', 'zCostList', 'zDealList', 'zTransformList', 'zVisitList']
      // params.forEach(str => {
      //   data[str].forEach(item => {
